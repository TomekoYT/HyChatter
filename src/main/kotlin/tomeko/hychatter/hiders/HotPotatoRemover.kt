...
object HotPotatoRemover {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeHotPotato || !HypixelPackets.onHypixel) return true
        ...
        return !message.matches(LanguageData.HOT_POTATO)
    }
}
