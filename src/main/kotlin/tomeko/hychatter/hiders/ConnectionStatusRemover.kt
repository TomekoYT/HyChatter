...
object ConnectionStatusRemover {
    fun register() {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeConnectionStatus || !HypixelPackets.onHypixel) return true
        ...
        return !message.matches(LanguageData.PLAYER_CONNECTION_STATUS)
    }
}
