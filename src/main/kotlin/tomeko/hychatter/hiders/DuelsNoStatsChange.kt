...
object DuelsNoStatsChange {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeDuelsNoStatsChange || !HypixelPackets.onHypixel) return true
        ...
        return !message.matches(LanguageData.DUELS_NO_STATS_CHANGE)
    }
}
