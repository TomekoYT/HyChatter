...
object ServerConnectedMessage {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removedServerConnectedMsgs || !HypixelPackets.onHypixel) return true
        ...
        return !message.matches(LanguageData.SERVER_CONNECTED)
    }
}
