...
object SoulWellAnnouncerRemover {
    fun register() {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeSoulWellAnnouncements || !HypixelPackets.onHypixel) return true
        ...
        return !message.matches(LanguageData.SOUL_WELL_FIND)
    }
}
