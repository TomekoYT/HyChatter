...
object GameAnnouncementsRemover {
    fun register() {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeGameAnnouncements || !HypixelPackets.onHypixel) return true
        ...
        return !message.matches(LanguageData.GAME_ANNOUNCEMENT)
    }
}
