...
object ReplayRecordedRemover {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeReplayMessage || !HypixelPackets.onHypixel) return true
        ...
        return !message.matches(LanguageData.REPLAY_RECORDED)
    }
}
