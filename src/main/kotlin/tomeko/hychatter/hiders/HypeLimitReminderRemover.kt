...
object HypeLimitReminderRemover {
    fun register() {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeHypeLimitReminder || !HypixelPackets.onHypixel) return true
        ...
        return !message.startsWith(LanguageData.HYPE_LIMIT)
    }
}
