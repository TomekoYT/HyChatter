...
object DuelsBlockTrail {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeDuelsBlockTrailDisabled || !HypixelPackets.onHypixel) return true
        ...
        return message != LanguageData.DUELS_BLOCK_TRAIL
    }
}
