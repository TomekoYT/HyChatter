...
object LobbyFishingAnnouncementRemover {
    fun register() {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeLobbyFishingMsgs || !HypixelPackets.onHypixel) return true
        ...
        return !message.matches(LanguageData.LOBBY_FISHING_ANNOUNCEMENT)
    }
}
