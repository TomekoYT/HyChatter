...
object SeasonalCollectedRemover {
    fun register() {
    ...
    private fun onGameReceive(component: Component, fromActionBar: Boolean): Boolean {
        if (fromActionBar || !HyChatterConfig.removeSimulatorCollectedMsgs || !HypixelPackets.onHypixel) return true
        ...
        return !message.matches(LanguageData.SIMULATOR_MESSAGES)
    }
}
