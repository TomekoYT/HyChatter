...
object HyChatterConfig : Config("${Constants.MOD_ID}.json", Constants.MOD_ICON, Constants.MOD_NAME, Category.HYPIXEL) {
    ...
    @Switch(
        title = "Dangerous Taunt Waypoint",
