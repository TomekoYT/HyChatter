...
//?}
import tomeko.hychat.location.HypixelPackets
...
object DangerousTauntWaypoint {
    ...
    fun onChat(
        ...
        if (!HyChatConfig.debugModeEnabled && (!HyChatConfig.dangerousTauntWaypointEnabled || !HypixelPackets.inFarmHunt)) return
